...
1. Let $G(s) = \frac{K}{s + 1}$.  Find the nyquist plot for the negative unity feedback system.
   ...
   | $\omega$ | $0 \angle - 90^{\circ}$  |
   
   Plotting semicircle:

   \[\lim_{r \to \infty} G(re^{j\phi}) = \lim_{r \to \infty}\frac{K}{re^{j\phi} + 1} \approx \lim_{r \to \infty}\frac{K}{re^{j\phi}} = |0|\angle e^{-j\phi}\]

   | $\phi         | $\lim_{r \to \infty}G(re^{j\phi})$ |
   |---------------+------------------------------------|
   | /             | <>                                 |
   | $90^{\circ}$  | $\angle -90^{\circ}$               |
   | $0^{\circ}$   | $\angle 0^{\circ}$                 |
   | $-90^{\circ}$ | $\angle 90^{\circ}$                |
#+end_examples
