...
$$ \begin{aligned}   
\oint_0^{2 \pi} \overrightarrow{H}(\rho) \hat{a}_{\phi} \overrightarrow{dl} = \oint_0^{2 \pi} \overrightarrow{H}(\rho) \hat{a}_{\phi} \rho d\phi = H(\rho) 2 \pi \rho = I_{Tot} \\
H(\rho) = \frac{I_{Tot}}{2 \pi \rho}
\end{aligned} $$
